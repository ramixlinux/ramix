...
build_base() {
	...
	mkdir -p $DESTDIR/boot $DESTDIR/bin $DESTDIR/dev $DESTDIR/etc $DESTDIR/home $DESTDIR/lib $DESTDIR/mnt $DESTDIR/proc $DESTDIR/root $DESTDIR/sbin $DESTDIR/sys $DESTDIR/tmp $DESTDIR/usr $DESTDIR/var
